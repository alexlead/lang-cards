    ...
    return (
        <>
            <div className="position-fixed top-0 start-0 d-inline-block">
                ...
                <button className="btn btn-primary " type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" onClick={() => handleSidebarStatus('show')} style={{ transform: "rotate(90deg)", transformOrigin: "left bottom" }}>
